...
fn render_rust<S: State>() -> Result<(String, String, String), String> {
    ...
    for (enum_name, variants) in &enums {
        let derives = merged_derives(ENUM_DERIVES, rust_derives.enum_derives(enum_name));
        writeln!(
            enums_output,
    ...
    for struct_name in &struct_order {
        ...
        let derives = merged_derives(STRUCT_DERIVES, rust_derives.struct_derives(struct_name));
        writeln!(
            structs_output,
