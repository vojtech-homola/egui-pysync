...
def pytest_configure(config):
    """Build the native probe and generate test bindings before collection."""
...
@pytest.fixture
def server_bundle():
    """Yield a running server and fail teardown on unexpected callback errors."""
    # Bindings are generated by pytest_configure after this module is imported.
    from egui_states_test_bindings import StatesServer  # noqa: PLC0415
